...
def CreateConnector(urls: list[str]) -> list[RemoteConnector]:
    """
    ...
    for url in urls:
        ...
        connectors.append(connector if not GlobalConfig.is_debug() else RemoteConnectorDebugWrapper(connector))
    return connectors
